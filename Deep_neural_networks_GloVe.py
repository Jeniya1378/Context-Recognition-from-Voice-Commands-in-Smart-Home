...
CNN_Glove_model.compile(loss='binary_crossentropy', optimizer="adam", metrics=[tfa.metrics.F1Score(num_classes=numOfClasses,average='weighted'),'binary_accuracy','accuracy', AUC()])
CNN_Glove_model.summary()

if dataset_selection == "4":
    CNN_Glove_model_fit = CNN_Glove_model.fit(X_tra, y_tra, class_weight=class_weights_dict,batch_size=batch_size2, epochs=num_epochs, validation_data=(X_val, y_val), callbacks=[early])
else:
...
RNN_Glove_model.compile(loss='binary_crossentropy', optimizer="adam", metrics=[tfa.metrics.F1Score(num_classes=numOfClasses,average='weighted'),'binary_accuracy','accuracy', AUC()])
RNN_Glove_model.summary()

if dataset_selection == "4":
    RNN_Glove_model_fit = RNN_Glove_model.fit(X_tra, y_tra, class_weight=class_weights_dict,batch_size=batch_size2, epochs=num_epochs, validation_data=(X_val, y_val), callbacks=[early])
else:
...
LSTM_Glove_model.compile(loss='binary_crossentropy', optimizer="adam", metrics=[tfa.metrics.F1Score(num_classes=numOfClasses,average='weighted'),'binary_accuracy','accuracy', AUC()])
LSTM_Glove_model.summary()

if dataset_selection == "4":
    LSTM_Glove_model_fit = LSTM_Glove_model.fit(X_tra, y_tra,class_weight=class_weights_dict, batch_size=batch_size2, epochs=num_epochs, validation_data=(X_val, y_val), callbacks=[early])
else:
...
Bi_LSTM_Glove_model.compile(loss='binary_crossentropy', optimizer="adam", metrics=[tfa.metrics.F1Score(num_classes=numOfClasses,average='weighted'),'binary_accuracy','accuracy', AUC()])
Bi_LSTM_Glove_model.summary()

if dataset_selection == "4":
    Bi_LSTM_Glove_model_fit = Bi_LSTM_Glove_model.fit(X_tra, y_tra, class_weight=class_weights_dict,batch_size=batch_size2, epochs=num_epochs, validation_data=(X_val, y_val), callbacks=[early])
else:
    Bi_LSTM_Glove_model_fit = Bi_LSTM_Glove_model.fit(X_tra, y_tra, batch_size=batch_size2, epochs=num_epochs, validation_data=(X_val, y_val), callbacks=[early])
...
GRU_Glove_model.compile(loss='binary_crossentropy',optimizer="adam",metrics=[tfa.metrics.F1Score(num_classes=numOfClasses,average='weighted'),'binary_accuracy','accuracy', AUC() ])
GRU_Glove_model.summary()

if dataset_selection == "4":
    GRU_Glove_model_fit = GRU_Glove_model.fit(X_tra, y_tra, class_weight=class_weights_dict,batch_size=batch_size2, epochs=num_epochs, validation_data=(X_val, y_val), callbacks=[early])
else:
